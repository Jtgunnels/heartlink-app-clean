...
// ---------------------------------------------------------------------------
// HeartLink ASE 1.3 — Acute Decompensation Trial Runner (Overlay / No-Clamp)
// ---------------------------------------------------------------------------
// Evaluates sensitivity and escalation accuracy under worsening conditions.
// ---------------------------------------------------------------------------

import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import calculateScore_ASE13 from "./calculateScore_ASE13F_FINAL_CL.js"; // ✅ adjust if file is in same folder
...
// Input & output paths
const INPUT_PATH = path.join(__dirname, "AcuteDecompensationScenarios_ASE13.json");
const OUT_DIR = __dirname;
const OUT_CSV = path.join(OUT_DIR, `Phase_B2_ASE13_Overlay_Acute_Results_${DATE}.csv`);
const OUT_SUMMARY = path.join(OUT_DIR, `Phase_B2_ASE13_Overlay_Acute_Summary_${DATE}.json`);
